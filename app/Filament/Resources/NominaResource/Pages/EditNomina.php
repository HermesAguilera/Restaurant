            ...
            \Filament\Actions\Action::make('addEmpleado')
                ...
                ->action(function (array $data) {
                    ...
                    foreach ($empleadosIds as $empleadoId) {
                        ...
                        // Aplicar división según tipo_pago (campo de la tabla nominas)
                        switch ($nomina->tipo_pago) {
                            case 'quincenal':
                                $sueldo = $sueldo / 2; // 50% del sueldo
                                break;
                            case 'semanal':
                                $sueldo = $sueldo / 4.33; // Aprox. 23% del sueldo (52/12 semanas por mes)
                                break;
                            case 'mensual':
                            default:
                                // No hay cambios, se usa el 100%
                                break;
                        }
                        // Calcular deducciones basadas en el sueldo ajustado
