...
class PercepcionesPolicy
{
    ...
    {
        return $user->can('delete_any_percepciones');
    }
    ...
    {
        return $user->can('force_delete_any_percepciones');
    }
    ...
    {
        return $user->can('restore_any_percepciones');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Percepciones $percepciones): bool
    {
        return $user->can('replicate_percepciones');
    }
    ...
    {
        return $user->can('reorder_percepciones');
    }
}
