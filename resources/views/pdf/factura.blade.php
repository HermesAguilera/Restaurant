...
<body class="text-sm text-gray-800">
    <div class="max-w-3xl mx-auto bg-white p-6">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm mb-4">
            ...
            <div>
                <p><strong>Cliente:</strong> {{ $factura->nombre_cliente ?? 'Consumidor Final' }}</p>
            ...
            <tbody>
                @foreach ($factura->detalles as $detalle)
                    <tr>
                        ...
                        <td class="border px-2 py-1 font-mono tracking-widest">{{ $detalle->producto->producto->codigo ?? 'N/A' }}</td>
